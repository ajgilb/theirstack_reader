...
function processJobsForDatabase(jobs) {
    ...
    // Filter out null entries (excluded companies)
    const filteredJobs = processedJobs.filter(job => job !== null);
    ...
    console.info(`Returning ${filteredJobs.length} jobs after filtering`);
